...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t bg-gray-50/50 font-medium [&_tr]:last-child:border-0", className)}
    {...props}
  />
));
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-6 text-left align-middle text-xs font-medium uppercase tracking-wider text-gray-500 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
